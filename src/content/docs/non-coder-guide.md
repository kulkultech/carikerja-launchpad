...
description: Learn how to edit pages and contribute to the Carikerja Launchpad portal directly through the GitHub website.
---

You do not need to be a software engineer or know how to write code to contribute to the **Carikerja Launchpad** portal! 
...
*(Alternatively, you can browse the [GitHub repository](https://github.com/kulkultech/carikerja-launchpad) and navigate to `src/content/docs/` where all pages are stored).*
...
## 📝 How to Add a New Page (e.g., Your Launcher Profile)

If you are a new launcher and want to add your profile page to the **Launchers Directory**, do it directly on the GitHub website:

1. Navigate to the **`src/content/docs/launchers/`** directory in our [GitHub Repository](https://github.com/kulkultech/carikerja-launchpad/tree/main/src/content/docs/launchers).
...
4. Paste the following template into the file editor and replace it with your bio:
   ...
   - **Background:** (Describe your background, major, or current job)
   - **Service Offerings:** (E.g. full-stack web apps, mobile apps, automated bots)
   - **Niche/Focus:** (E.g. local brick-and-mortar stores, SaaS startups, AI integration)
   - **Why I joined the Launchpad:** (Your goals for freelance or agency growth)
   ```
