---
title: "Step 1: Mindset & Portal Setup"
description: Introduction to the unbankruptable freelance mindset and git portal cloning.
---
...
1. Go to the [Carikerja Launchpad GitHub Repo](https://github.com/kulkultech/carikerja-launchpad) and click **Fork** (keep the name `carikerja-launchpad`).
